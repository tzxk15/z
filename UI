    ...
    function Lib:CreateWindow(Name)
        ...
        Main.ImageColor3 = Color3.fromRGB(3, 3, 3)
        ...
        glow.Name = "glow"
        glow.Parent = Main
        glow.BackgroundColor3 = Color3.fromRGB(255, 2, 2)
        glow.BackgroundTransparency = 908
        glow.BorderSizePixel = 1
        glow.Position = UDim2.new(0, -15, 0, -15)
        glow.Size = UDim2.new(1, 30, 1, 30)
        glow.Image = "rbxassetid://4996891970"
        glow.ImageColor3 = Color3.fromRGB(255, 2, 2)
        glow.ScaleType = Enum.ScaleType.Slice
        glow.SliceCenter = Rect.new(20, 20, 280, 280)

        buttonHolder.Name = "buttonHolder"
        buttonHolder.Parent = Main
        buttonHolder.BackgroundColor3 = Color3.fromRGB(5, 5, 5)
        ...
        Title_2.ZIndex = 2
        Title_2.Font = Enum.Font.Roboto --aaxd
        Title_2.Text = Name
        ...
        Minimize.Active = true -- aqui le movi
        ...
        Minimize.TextStrokeTransparency = 0.930

        glow_2.Name = "glow"
        glow_2.Parent = Title
        glow_2.BackgroundColor3 = Color3.fromRGB(255, 2, 2)
        glow_2.BackgroundTransparency = 908
        ...
        glow_2.ImageColor3 = Color3.fromRGB(255, 2, 2)
...
local function AddDrag(frame1, frame2)
...
AddDrag(Title_2, Main)
        ...
        function Window:Dropdown(name, options, callback)
            ...
            TextBox.PlaceholderColor3 = Color3.fromRGB(199, 199, 188)
        ...
        function Window:Bind(name, options, callback)
            ...
            Text_4.Font = Enum.Font.Roboto -- aquoi le movi
            Text_4.Text = name
            ...
            Text_4.MouseButton1Click:Connect(function()
                ...
                Check = game:GetService("UserInputService").InputBegan:Connect(function(key)
                    ...
                    elseif key.KeyCode == Enum.KeyCode.Escape then
                        ...
                        location[flag] = nil
                        Check:Disconnect() 
                        wait(.6) -- AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAASDASDA ACA
                        Usable = true
                    end
                end)
            end)
        ...
        function Window:Section(text)
            ...
            Title_2.Name = "Title"
            Title_2.Parent = Title
            Title_2.BackgroundColor3 = Color3.fromRGB(3, 3, 3)
            ...
            Title_2.Text = " "..text
            Title_2.TextColor3 = Color3.fromRGB(240, 255, 255)
            ...
            glow.Parent = Title_2
            glow.BackgroundColor3 = Color3.fromRGB(255, 2, 2)
            glow.BackgroundTransparency = 1.100
            glow.BorderSizePixel = 0
            glow.Position = UDim2.new(0, -15, 0, -15)
            glow.Size = UDim2.new(1, 29, 1, 29)
            glow.Image = "rbxassetid://4996891970"
            glow.ImageColor3 = Color3.fromRGB(255, 2, 2)
            glow.ScaleType = Enum.ScaleType.Slice
            glow.SliceCenter = Rect.new(20, 20, 280, 280)
        ...
        function Window:Label(text)
            ...
            TextLabel.Font = Enum.Font.Robot
            TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
            TextLabel.TextSize = 12.000
            TextLabel.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
            TextLabel.TextStrokeTransparency = 0.920
